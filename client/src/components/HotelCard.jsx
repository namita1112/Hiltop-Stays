...
const HotelCard = ({hotel, index}) => {
  return (
    ...
    // <Link to={'/hotel-details/' + hotel._id} onClick={() => scrollTo(0,0)} key={hotel._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white 
    ...
    //       <p><span className='text-xl text-gray-800'>₹ 2000/night</span></p>
